...
<div class="article-form">
    ...
    <label>Status</label>
    <?= Html::dropDownList('status', 1, $newStatus_list, ['class' => 'form-control', 'id' => 'article-status']) ?>
    ...
    <?= $form->field($model, 'peoples_voices')->textInput(['id' => 'article-rating']) ?>

    <?= $form->field($model, 'content')->textInput(['maxlength' => true, 'id' => 'article-content']) ?>
