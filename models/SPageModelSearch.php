...
use app\models\SPageModel;

/**
 * SPageModelSearch represents the model behind the search form of `app\models\SPageModel`.
 */
class SPageModelSearch extends SPageModel
{
  public $id;
  public $author;
  public $slug;
